...
class AddPacking extends StatefulWidget {
  const AddPacking({Key? key}) : super(key: key);

  @override
  _AddPackingState createState() => _AddPackingState();
}

class _AddPackingState extends State<AddPacking> {
  DataController controller = Get.put(new DataController(Roles.packing.name));
            ...
            ElevatedButton(
              onPressed: () => {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        AddStudentPage(role: Roles.packing.name),
                  ),
                ),
              },
              child: Text('Add'),
