...
class AddRanch extends StatefulWidget {
  const AddRanch({Key? key}) : super(key: key);

  @override
  _AddRanchState createState() => _AddRanchState();
}

class _AddRanchState extends State<AddRanch> {
  final DataController controller =
      Get.put(DataController(Roles.ranchOwner.name));
  void initState() {
            ...
            ElevatedButton(
              onPressed: () => {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        AddStudentPage(role: Roles.ranchOwner.name),
                  ),
                ),
              },
              child: Text('Add'),
