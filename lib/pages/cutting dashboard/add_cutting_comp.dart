...
class AddCutting extends StatefulWidget {
  const AddCutting({Key? key}) : super(key: key);

  @override
  _AddCuttingState createState() => _AddCuttingState();
}

class _AddCuttingState extends State<AddCutting> {
  final DataController controller =
      Get.put(new DataController(Roles.cutting.name));
  void initState() {
            ...
            ElevatedButton(
              onPressed: () => {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        AddStudentPage(role: Roles.cutting.name),
                  ),
                ),
              },
              child: Text('Add'),
